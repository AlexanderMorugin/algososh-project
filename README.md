...
В данном проекте написаны алгоритмы работы разворота строки, рассчета числа Фибоначчи и сортировки массива и настроить визуализацию этих алгоритмов. Так же создать классы Стек, Очередь и Связный список и их принципы работы. Для компонентов описаны Unit и E2E тесты. Эта проектная работа заточена на анимацию и поэтапное отображение работы алгоритма, что позволит детальнее понять каждый шаг его работы.
